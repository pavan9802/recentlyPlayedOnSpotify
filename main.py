...
class SaveSongs:
    ...
    def find_songs(self):
        ...
        limit = 50
        query = "https://api.spotify.com/v1/me/player/recently-played?limit={}".format(
            limit)
    ...
    def create_playlist(self):
        ...
        request_body = json.dumps({
            "name": "Recently Played", "description": "A playlist of some of you most recently played songs", "public": True
        })
